...
<body class="bg-light d-flex justify-content-center align-items-center vh-100" style="width: 100vw; height: 100vh; overflow: auto;">
    <div class="card p-4 shadow-sm" style="width: 700px; max-width: 90vw;">
...
<form action="register.php" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="section" name="section" placeholder="e.g. 3rd year BSIT3B" required />
            </div>
            <div class="col-12">
